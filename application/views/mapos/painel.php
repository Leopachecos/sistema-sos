    ...
    echo "['" . $o->status . "', " . $o->total . "],";
            ...
            var plot1 = jQuery.jqplot('chart-os', [data], {
                seriesDefaults: {
                    ...
                    seriesColors: ['#436eee','#8a083a','#00cd00','#c40404','#e64500','#000000','#fffc3b'], //COR DE CADA BARRA DO GRAFICO DE PIZZA "ESTATISTICAS DE OS", ALTERAR CONFORME ORDEM DE EXIBICAO
