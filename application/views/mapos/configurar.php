                        ...
                        <div class="form-actions">
                            <div class="span8">
                                ...
                                <div class="span12">
                                    ...
                                    <label> <input <?= @in_array("Em Atendimento", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Em Atendimento"> <span class="lbl"> Em Atendimento</span> </label>                                  
                                    <label> <input <?= @in_array("Aguardo Cliente", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Aguardo Cliente"> <span class="lbl">Aguardo Cliente</span> </label>                                  
                                    ...
                                    <label> <input <?= @in_array("Aguardando Retirar", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Aguardando Retirar"> <span class="lbl"> Aguardando Retirar</span> </label>
