...
<?php
    ...
    <div class="span12" style="margin-left: 0">
        ...
        } elseif ($r->status == "Aguardo Cliente") {
            $status = '<span class="label label-info">Aguardo Cliente</span>';
        } elseif ($r->status == "Aguardando Retirar") {
            $status = '<span class="label label-info">Aguardando Retirar</span>';
        } elseif ($r->status == "Aguardando Peças") {
            $status = '<span class="label">Aguardando Peças</span>';
        } else {
            $status = '<span class="label">Em Atendimento</span>';
        }
        echo '<tr>';
        echo '<td>' . $r->idOs . '</td>';
        echo '<td>' . $r->nome . '</td>';
