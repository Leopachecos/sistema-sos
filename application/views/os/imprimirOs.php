                            ...
                            <tbody>
                                <?php if ($emitente == null) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 18%; text-align: center"><b style="font-size: 20px;">N° OS:</b> <span style="font-size: 20px;"><?php echo $result->idOs ?></span></br> </br> <span>Emissão: <?php echo date('d/m/Y') ?></span></td>
                                        </span>
                                        </td>
                                    </tr>
