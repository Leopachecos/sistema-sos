                        ...
                        <table class="table table-condensed">
                            ...
                            <?php if ($emitente == null) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><span style="font-size: 20px; "> S.O.S Centro Eletrônico</span> </br>
                                    ...
                                    <td style="width: 18%; text-align: center "><b style="font-size: 15px; ">N° OS:</b>
                                        <span style="font-size: 20px; "><?php echo $result->idOs ?></span></br> </br>
                    ...
                    <div style="margin-top: 0; padding-top: 0">
                        ...
                        <table class="table table-condensed">
                            ...
                            <tr>
                                    <td>
                                        <b>CIDADE: </b>
                                        <?php echo $result->cidades ?>
                                    </td>
                                    <td>
                                        <b>ATENDENTE: </b>
                                        <?php echo $result->atendente ?>
                                    </td>
                                     <?php if ($result->garantiaTipo != 'Nenhum') { ?>
                                    <td colspan="6">
                                        <b>TIPO DE GARANTIA: </b>
                                        <?php echo htmlspecialchars_decode($result->garantiaTipo) ?>
                                    </td>
                                    <?php } ?>
                            </tr>        
                                <tr>
