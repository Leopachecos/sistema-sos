        ...
        $cor = '#E0E4CC';
            ...
            return [
                ...
                'extendedProps' => [
                    ...
                    'garantiaTipo' => '<b>Tipo de Garantia:</b> ' . $os->garantiaTipo,
                    'status' => '<b>Status da OS:</b> ' . $os->status,
                    'cidades' => '<b>Cidade:</b> ' . $os->cidades,
                    'description' => '<b>Descrição/Produto:</b> ' . $os->descricaoProduto,
                    'marcaProduto' => '<b>Marca:</b> ' . $os->marcaProduto,
                    'serieProduto' => '<b>Número de Série:</b> ' . $os->serieProduto,
                    'codfab' => '<b>Cod. Fab. :</b> ' . $os->codfabProduto,
