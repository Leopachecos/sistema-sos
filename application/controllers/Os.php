    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run('os') == false) {
            ...
            $data = [
                ...
                'serieProduto' => set_value('serieProduto'),
                'codfabProduto' => set_value('codfabProduto'),
                'corProduto' => set_value('corProduto'),
                'defeito' => set_value('defeito'),
                'status' => set_value('status'),
                'cidades' => set_value('cidades'),
                'garantiaTipo' => set_value('garantiaTipo'),
    ...
    public function editar()
    {
        ...
        if ($this->form_validation->run('os') == false) {
            ...
            $data = [
                ...
                'serieProduto' => $this->input->post('serieProduto'),
                'codfabProduto' => $this->input->post('codfabProduto'),
                'corProduto' => $this->input->post('corProduto'),
                'defeito' => $this->input->post('defeito'),
                'status' => $this->input->post('status'),
                'garantiaTipo' => $this->input->post('garantiaTipo'),
